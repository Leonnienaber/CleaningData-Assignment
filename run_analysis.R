...
# Dplyr package to be installed and loaded.
# Set that this script is in the same directory as the 'UCI HAR Dataset' folder
...
featlist <- read.delim("./UCI HAR Dataset/features.txt", header = FALSE, stringsAsFactors = FALSE)
...
activ <- read.table("./UCI HAR Dataset/activity_labels.txt", stringsAsFactors = FALSE)
